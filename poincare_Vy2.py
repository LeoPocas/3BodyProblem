...
for i in range(1, len(t_eval)):
    ...
    if (r2[1, i-1] - y_target) * (r2[1, i] - y_target) < 0:
        # Interpolação linear para encontrar o cruzamento
        x_cross = r2[0, i-1] + (r2[0, i] - r2[0, i-1]) * (y_target - r2[1, i-1]) / (r2[1, i] - r2[1, i-1])
        vx_cross = v2[0, i-1] + (v2[0, i] - v2[0, i-1]) * (y_target - r2[1, i-1]) / (r2[1, i] - r2[1, i-1])
...
plt.savefig("poincare_section_body2_y_target-10.png", dpi=300, bbox_inches='tight')
plt.show()